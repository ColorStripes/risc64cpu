...
module arbitrate (
    ...
    output reg [AXI_ID_WIDTH-1:0] AXI_id,

    input wire AXI_ready,
    input wire [AXI_ID_WIDTH-1:0] AXI_out_id,
...
always @(*) begin
    ...
    AXI_req = 2'b0;
    AXI_size = 2'b0;
    AXI_id = {AXI_ID_WIDTH-1{1'b0}, 1'b0};
    if(mem_valid) begin
        AXI_addr = mem_addr;
        ...
        AXI_req = mem_req;
        AXI_size = mem_sel;
        AXI_id = {AXI_ID_WIDTH-1{1'b0}, 1'b1};
    end
        ...
        AXI_req = if_req;
        AXI_size = if_size;
        AXI_id = {AXI_ID_WIDTH-2{1'b0}, 2'b11};
    end
end
...
always @(*) begin
    ...
    if(AXI_ready) begin
        if(AXI_out_id == {AXI_ID_WIDTH-1{1'b0}, 1'b1}) begin
            mem_data = AXI_r_data;
            mem_ready = AXI_ready;
        end
        else if(AXI_out_id == {AXI_ID_WIDTH-2{1'b0}, 2'b11}) begin
