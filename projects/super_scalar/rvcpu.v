...
wire [`CACHE_LINE] arbiter_data;

//AXI
wire [`CACHE_LINE] AXI_r_data;
wire [`PC_BUS]   AXI_addr;
wire [`CACHE_LINE] AXI_w_data;
wire AXI_vaild;
wire AXI_ready;
wire AXI_req; 
wire [3 : 0] AXI_ret_id;
...
//
wire axi_wr;
wire [`PC_BUS] axi_address;
wire [`CACHE_LINE] axi_stor_data;
//
wire [`DATA_BUS] dcache_data;
...
wire [`PC_BUS] icache_address;
wire [`DATA_BUS] icache_data;
...
//mem
wire [`DATA_BUS] mem_data;
wire [1 : 0]       mem_size;
wire               mem_req;
wire [`MEM_BUS] mem_addr;
wire [`DATA_BUS] mem_stor_data;
//handshake
